...
def get_arguments():
    ...
    parser.add_argument('--nc_z',type=int,help='noise # channels',default=1) #3
    parser.add_argument('--nc_im',type=int,help='image # channels',default=1) #3
    ...
    parser.add_argument('--max_size', type=int,help='image minimal size at the coarser scale', default=340)
    ...
    parser.add_argument('--alpha',type=float, help='reconstruction loss weight',default=10)  #10
